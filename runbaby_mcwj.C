{
  ...
  // ch->Add("/hadoop/cms/store/user/sicheng/babies/wjets_sl_4.root");
  // ch->Add("/home/users/sicheng/makebaby/bob/babies/wjets_g2jg1b_4.root");
  ch->Add("/home/users/sicheng/makebaby/bob/babies/wjets_g1j0b_8.root");

  ScanChain(ch, "_omcwj_");
